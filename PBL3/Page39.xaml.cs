    ...
    public partial class Page39 : Page
    {
        ...
        private async Task LoadDataAsync()
        {
            ...
            try
            {
                ...
                // Truy v?n danh sách b?ng lái xe c?a ngý?i này
                ...
                var licensesList = dbLicenses.Select(l => new LicenseItem39
                {
                    ...
                    Points = l.Points,
                    Status = l.StatusText ?? "Chýa r?",
                    IssueDateStr = l.IssueDate != DateTime.MinValue ? l.IssueDate.ToString("dd/MM/yyyy") : "Chýa c?p nh?t",
        ...
        {
            new CustomMessageBox("Ch?c nãng thêm GPLX ðang ðý?c c?p nh?t.").ShowDialog();
        }
        ...
        {
            new CustomMessageBox("Ð? lýu thông tin GPLX thành công!", "Thông báo").ShowDialog();
        }
